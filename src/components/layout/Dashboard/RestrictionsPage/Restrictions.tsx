              ...
              onChange={(e) => {
                ...
                if (file) {
                  ...
                  reader.onload = () => {
                    ...
                    console.log(data); // base64 encoded string
                  };
      ...
      <Grid container spacing={2} sx={{ height: "90%", width: "100%" }}>
        ...
        >
          ...
          <Stack
            ...
            spacing={2}
            sx={{ ...styles.card, flex: 1 }}
          >
            <Typography
              variant="h6"
              sx={{ ...styles.primary, fontWeight: 600, marginBottom: "1rem" }}
            >
              Word Limits
            </Typography>
            <WordLimit
              ...
              inputValueAI={inputValueAI}
              setInputValueAI={setInputValueAI}
            />
          </Stack>
        </Stack>
