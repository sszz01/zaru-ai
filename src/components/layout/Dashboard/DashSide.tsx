...
const items: MenuProps["items"] = [
  {
    key: "1",
    label: (
      <Typography variant="body1" style={{ ...textStyles.secondary1 }}>
        Dashboard
      </Typography>
    ),
    icon: <DashboardIcon />,
  ...
  return (
    <div style={styles.sidebar}>
      ...
      <div style={styles.logoContainer}>
        <Typography variant="h5" fontWeight={700} style={textStyles.primary}>
          ZaruAI
        </Typography>
      </div>
      ...
      {/* Logout button */}
      <div
        style={{ ...styles.logoutButton, fontWeight: 500 }}
        onClick={() => {
          handleTransition(() => {
            auth.signOut();
            onClose();
      ...
      >
        ...
        <Typography
          variant="body1"
          component="span"
          sx={{ marginLeft: 0, fontFamily: "Poppins, sans-serif" }}
        >
          Logout
        </Typography>
      </div>
