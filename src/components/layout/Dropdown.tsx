...
export function Dropdown({
  ...
  styles,
    ...
    return (
        <Menu id="basic-menu" anchorEl={anchorEl} open={open} onClose={handleMenuClose} anchorOrigin={{
            vertical: "bottom",
            horizontal: "right"
        }} transformOrigin={{
            vertical: "top",
            ...
            <MenuItem id="settings" sx={{ ...styles.poppins,
                fontSize: 15,
                borderRadius: 2,
                color: "#5e646e",
                fontFamily: "Poppins",
            ...
            <MenuItem id="logout" sx={{ ...styles.poppins,
                fontSize: 15,
                borderRadius: 2,
                color: "#ff0000",
                fontFamily: "Poppins",
